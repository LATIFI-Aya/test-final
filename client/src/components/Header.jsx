              ...
              <div>
                {!user ? ( 
                  <FaUser />
                    ...
                    <img src={user && user.profileImagePath ? `http://localhost:4000/${user.profileImagePath.replace("public", "")}` : "/default-image-path.jpg"} alt="" height={47} width={47} className='rounded-full object-cover aspect-square' />
                  )}
              </div>
              {dropdownMenu && !user &&(
